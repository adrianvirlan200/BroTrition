...
export default function MainTable() {
      ...
      case "calories":
        return (
          <div className="grid grid-cols-2 gap-x-0 w-28">
            <div>
              {displayNumberOfCalories(data.proteins, data.carbs, data.fats)}
            </div>
            <div>Kcal</div>
          </div>
        );
  ...
  return (
    <div className="w-1/2 min-w-fit ml-unit-40 p-2 bg-white rounded-xl">
      <div className="m-2">
        <Button
          variant="light"
          color="success"
        ...
        <Button variant="light" color="primary" className="text-lg font-medium">
          ADD EXERCISE
        </Button>
        <Button
          variant="light"
        ...
        <Button variant="light" color="warning" className="text-lg font-medium">
          ADD BIOMETRICS
        </Button>
      </div>
      <Table
